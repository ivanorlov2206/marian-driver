...
int marian_generic_init(struct marian_card*);
void marian_proc_status_generic(struct marian_card*, struct snd_info_buffer*);
void marian_proc_ports_generic(struct marian_card*, 
